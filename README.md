...
| `0x800EDEE8` | Authentication | Main Authentication Function | ⚠️ | [dwc_auth_interface.cpp](/payload/dwc/dwc_auth_interface.cpp)<br>[Auth.cpp](/payload/wiimmfi/Auth.cpp) | Accurate Data Sent:<ul><li>Console Certificate</li><li>Device ID</li><li>Dolphin Version (if applicable)</li><li>Requested UPNP Port (if set)</li></ul>Faked Data Sent (subject to changes depending on reception of the project):<ul><li>Payload Version</li><li>Patcher Type</li><li>Game IOS</li><li>Console Type</li><li>Game Region</li></ul>Data Not Sent:<ul><li>UPNP Settings (cannot be set without dedicated patchers)</li><li>Disc Version (unused)</li><li>Patcher Version (WSZST only)</li><li>Reconnect Data (Auto Reconnect not implemented)</li></ul> |
